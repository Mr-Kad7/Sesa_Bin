...
ALTER TABLE pickups ADD COLUMN IF NOT EXISTS collector_email TEXT;
ALTER TABLE pickups ADD COLUMN IF NOT EXISTS eta TEXT;
ALTER TABLE pickups ADD COLUMN IF NOT EXISTS last_known_location TEXT;
ALTER TABLE pickups ADD COLUMN IF NOT EXISTS feedback TEXT;
ALTER TABLE pickups ADD COLUMN IF NOT EXISTS feedback TEXT;
